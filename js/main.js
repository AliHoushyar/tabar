...
function scrollFunction() {
      let fix = document.getElementById("fixnav");
      if (document.body.scrollTop > 60 || document.documentElement.scrollTop > 60) {
        ...
        document.getElementsByClassName('linkedcomp')[5].style.color = "#7825cb";
        ...
        document.getElementsByClassName('linkedcomp')[5].style.color = "white";
